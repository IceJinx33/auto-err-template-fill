...
tag2role = OrderedDict(
    {"Material": "Material", "Method": "Method", "Metric": "Metric", "Task": "Task"}
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Predicted output file",
    )
    parser.add_argument(
        "--gold_file", default=None, type=str, required=True, help="Gold file"
    )
    parser.add_argument(
        "--event_n", default=-1, type=str, required=False, help="event n"
    )
    parser.add_argument(
        "--out_file",
        default="dygie_scirex_preds.out",
        type=str,
        required=False,
    ...
    with open("./scirex_docids_event_n.json", encoding="utf-8") as f:
